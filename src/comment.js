...
const displayPop = async () => {
  getMeals().then((getMeal) => {
    ...
    <div class="meal-data">
    <h3> ${getMeal[0].strMeal} <h3>
    <img src="${getMeal[0].strMealThumb}" alt="Meal Image" class="meal-img">
    </div>
    ...
    <p class="instructions"> <b>Instructions:</b><br><br>${getMeal[0].strInstructions} </p>
</div>
